...
/*   Updated: 2021/03/24 16:02:09 by ericard@stu      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	drawsprite(t_infos *infos)
{
	...
	while (y < infos->sprite.drawendy)
	{
		...
		my_mlx_pixel_put(infos, infos->sprite.stripe, y, infos->textures[4].addr[texy * infos->textures[4].img_height + infos->sprite.texx]);
		y++;
	}
}
