...
/*   Updated: 2021/03/25 13:35:35 by ericard@stu      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	key_w_s(t_infos *infos, char key)
{
	if (key == 'w')
	{
		if (infos->map[(int)(infos->ray.posx + infos->ray.dirx * 0.1)][(int)infos->ray.posy] == '0')
			infos->ray.posx += infos->ray.dirx * 0.1;
		if (infos->map[(int)infos->ray.posx][(int)(infos->ray.posy + infos->ray.diry * 0.1)] == '0')
...
void	key_a_d(t_infos *infos, char key)
{
	if (key == 'd')
	{
		if (infos->map[(int)(infos->ray.posx - infos->ray.diry * 0.1)][(int)infos->ray.posy] == '0')
		infos->ray.posx += infos->ray.diry * 0.1;
		if (infos->map[(int)infos->ray.posx][(int)(infos->ray.posy + infos->ray.dirx * 0.1)] == '0')
